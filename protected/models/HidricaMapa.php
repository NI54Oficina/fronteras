...
/**
 * This is the model class for table "tbl_hidrica_mapa".
 *
 * The followings are the available columns in table 'tbl_hidrica_mapa':
 * @property integer $id
 * @property integer $nid
 * @property string $content
 */
class HidricaMapa extends CActiveRecord
{
	/**
	 ...
	 * @return HidricaMapa the static model class
	 */
	...
	public function CheckFeed(){
		...
		$data = @file_get_contents('http://www.fyo.com/clima/views/vista_necesidades_hidricas',false,$context);
		if($data){
