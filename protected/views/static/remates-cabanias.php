	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"c>
		...
		<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
			...
			<div class="col-lg-2-5 col-md-2-5 col-sm-2-5 col-xs-6">
				...
				<!--Contenido -->
				<div hid="1" class="container-modalidad"></div>
			...
			<div class="col-lg-2-5 col-md-2-5 col-sm-2-5 col-xs-6">
				...
				<!--Contenido -->
				<div hid="1" class="container-consignatorio">
			...
			<div class="col-lg-2-5 col-md-2-5 col-sm-2-5 col-xs-6">
				...
				<!--Contenido -->
				<div hid="1" class="container-lugar">
					<p>Bernasconi</p>
					<p>Néstor Hugo Fuentes S.A</p>
				</div>
			...
			<div class="col-lg-2-5 col-md-2-5 col-sm-2-5 col-xs-6">
				...
				<!--Contenido -->
				<div hid="1" class="container-provincia"></div>
			...
			<div class="col-lg-2-5 col-md-2-5 col-sm-2-5 col-xs-12">
				...
				<!--Contenido -->
				<div hid="1" class="container-cabezas">
					<p>900</p>
				</div>
