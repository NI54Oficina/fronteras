<section id="" class="col-lg-12 col-md-12 col-sm-12 col-xs-12 section">
	...
	<div class="box-nutricion border-shadow">
		<div class="box-nutricion-inner square">
			<p class="long-word p-nutricion">Tabla de Valores de Alimentos (NRC)</p>
		</div>
	</div>
	</div>
	...
	<div class="box-nutricion border-shadow">
		<div class="box-nutricion-inner square">
			<p class="long-word p-nutricion">Requerimientos nutricionales por categoría</p>
		</div>
	</div>
	</div>
	...
	<div class="box-nutricion border-shadow">	
		<div class="box-nutricion-inner square">
			<p class="long-word p-nutricion">Recomendaciones de confección de sitio</p>
		</div>
	</div>
	</div>
	...
	<div class="box-nutricion border-shadow">
		<div class="box-nutricion-inner square">
			<p class="p-nutricion">Modelizador de tambo</p>
		</div>
	</div>
	</div>
	...
	<div class="box-nutricion border-shadow">
		<div class="box-nutricion-inner square">
			<p class="p-nutricion">Modelizador de cría</p>
		</div>	
	</div>
	</div>
