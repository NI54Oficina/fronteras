...
<div class="col-xs-12 hidden-lg hidden-sm hidden-md hidden-xl titulo-mobile-producir titulo-mobile"> <p> Producir + > Links de intereses </p> </div>
	...
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7 "   >
		<p hid="1"> CRA</p>
		<div class="box-interes-inner square cra-link">
	...
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7"   >
		<p hid="1"> Crea</p>
		<div class="box-interes-inner square crea-link">
		</div>
	...
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7 "   >
		...
		<div class="box-interes-inner square sra-link">
	...
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7 "   >
		<p hid="1"> INTA </p>
		<div class="box-interes-inner square inta-link">
	...
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7 "   >
		<p hid="1"> SENASA </p>
		<div class="box-interes-inner square senasa-link">
	...
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7 "   >
		...
		<div class="box-interes-inner square feedlot-link">
	...
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7"   >
		<p hid="1"> IPCVA</p>
		<div class="box-interes-inner square ipvca-link">
	...
	<a href="#">
	<div class="box-interes col-lg-2-5 col-md-4 col-sm-4 col-xs-6 col-xl-7 box-relleno hidden-xs hidden-sm hidden-md"   >
