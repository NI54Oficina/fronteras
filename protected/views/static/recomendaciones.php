...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 general-container-producir container-recomendaciones">
				...
				Si queremos faenar animales de mayor peso en menor tiempo, llegar al entore a edad más temprana o
				 que las vacas paran un ternero sano y fuerte, tenemos que implementar planes sanitarios preventivos
				  y estratégicos acordes a la época, a la oferta forrajera y al destino del animal, para poder seguir
					 en el camino a la Frontera Productiva del establecimiento.
			</p>
		</div>
				...
				EL CONTROL PARASITOLÓGICO es muy importante en esta época (otoño-invierno), dado que el destete y la recría/invernada
				 son las categorías más sensibles a la acción de los parásitos.En Argentina, las pérdidas estimadas por ciclo productivo
				  en una invernada con infestación parasitaria baja (subclínicas) son de 20 a 30 kg de peso vivo y pueden ascender
					...
					(BOVIFORT®, BAGOMECTINA® FORTEAD3E, Bagomectina 3,15 LA AD3E y FLOK®) permite controlar por más tiempo las parasitosis
					 internas y externas (piojos, sarna, ura, garrapatas).Se recomienda la rotación de principios activos para evitar la
					  generación de resistencia. Esta rotación puede hacerse con productos como PARAXANE® 10% (bencimidazol) o PARAXANE®
						INYECTABLE (Ricobendazol) o FOSFAMISOL® (levamisol).
			</p>

			<p>
				LA CARENCIA DE MINERALES Y/O VITAMINAS genera mermas en la ganancia diaria de peso que oscilan entre 3 y 17 kg
				...
				en la absorción (molibdeno, azufre, etc.).Hay regiones ganaderas muy importantes de nuestro país donde es bien conocida
				 la carencia de cobre y zinc, como por ejemplo Cuenca del Salado. Además, hay que tener en cuenta que en situación de
				  lluvias intensas y encharcamiento de pasturas las carencias minerales aumentan.Por lo expuesto, la estrategia de
					 suplementación con cobre y zinc (SUPLENUT®) está indicada en situaciones de carencia de estos minerales.

			</p>

			<p>
				INMUNIDAD CONTRA ENFERMEDADES INFECCIOSAS:  </br>
    		<li>Síndrome respiratorio -> BIOPOLIGEN® HS / BIOPOLIGEN® AIR  </li>
    		<li>Síndrome clostridial -> POLICLOSTRIGEN® / BIOCLOSTRIGEN® J5 / TRIPLEpoligen®   </li>
    		<li>Síndrome de queratoconjuntivitis -> BIOQUERATOGEN® OLEO MAX   </li>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 box-recomendaciones">
		...
		<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 parrafo-recomendaciones">
    		...
    		<li>Síndrome de diarrea neonatal -> ROTATEC J5®   </li>
    		<li>Síndrome respiratorio -> BIOPOLIGEN® HS / BIOPOLIGEN® AIR</li>
			</p>

			<p>
				En las zonas con carencias minerales de cobre y zinc, es vital la suplementación inyectable de SUPLENUT® aplicándolo a las
